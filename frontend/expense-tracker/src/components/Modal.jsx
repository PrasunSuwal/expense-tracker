...
const Modal = ({ children, isOpen, onClose, title }) => {
  ...
  return (
    <div className="fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full h-screen overflow-y-auto overflow-x-hidden bg-black/20 bg-opacity-50 p-4">
      <div className="relative w-full max-w-2xl my-auto">
        {/* {Modal Content} */}
        <div className="relative bg-white text-gray-900 rounded-lg shadow-sm max-h-[90vh] flex flex-col">
          {/* {Modal Header} */}
